...
namespace eFMI.Misc
{
    public class EfmuKnownFileExtensions
    {
        public static string[] AlgoFileSuffices = {".mof", ".alg"};

        public const string ManifestFileSuffix = ".xml";
        public const string SchemaFileSuffix = ".xsd";
